...
class SQLiteHelper {
  Future<Database> inisiasiDB() async {
    ...
    return openDatabase(
      ...
      onCreate: (db, version) {
        db.execute(
          'CREATE TABLE bookmark(id INTEGER PRIMARY KEY AUTOINCREMENT, nomor VARCHAR, nama VARCHAR, asma VARCHAR, arti VARCHAR, ayat VARCHAR, teks TEXT)',
        );
      },
